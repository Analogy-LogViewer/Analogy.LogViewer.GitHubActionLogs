...
namespace Analogy.LogViewer.GitHubActionLogs.IAnalogy
{
    ...
    {
        protected override string RepositoryURL { get; set; } = "https://api.github.com/repos/Analogy-LogViewer/Analogy.LogViewer.GitHubActionLogs";
        ...
        public override string Name { get; set; } = "GitHub Actions Log Parser Data Provider";
